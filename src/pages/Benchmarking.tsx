...
export function Benchmarking({ projectId }: { projectId?: string }) {
  ...
  return (
    <div className="flex flex-col h-full">
          ...
          <>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={() => { setToast('Capital plan report generation coming soon.'); setTimeout(() => setToast(null), 3000); }} className="btn-primary inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white text-sm font-medium rounded-lg hover:bg-[#096A66]">
            ...
            <div className="bg-[#121C35] border border-[#1E2A45] rounded-xl overflow-hidden">
              <div className="p-6 border-b border-[#1E2A45] flex items-center justify-between">
                ...
                <button onClick={() => { setToast('CSV export coming soon.'); setTimeout(() => setToast(null), 3000); }} className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#1E2A45] border border-[#2A3A5C] rounded-lg text-xs font-medium text-[#9AA5B8] hover:bg-[#2A3A5C] hover:text-white transition-colors duration-150">
      ...
      {toast && (
        <div className="fixed bottom-6 right-6 z-50 bg-[#121C35] border border-[#1E2A45] text-white px-5 py-3 rounded-xl shadow-2xl text-sm font-medium flex items-center gap-3 animate-in slide-in-from-bottom-4 fade-in duration-300">
